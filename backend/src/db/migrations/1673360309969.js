module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('ventas', 'mongoGravado5', {
        transaction,
      });

      await queryInterface.removeColumn('ventas', 'mongoGravado10', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('contribuyentes', 'ruc', {
        transaction,
      });

      await queryInterface.removeColumn('contribuyentes', 'razonSocial', {
        transaction,
      });
