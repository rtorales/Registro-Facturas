...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/contribuyente/autocomplete`, { params });
  return response.data;
}

const ContribuyenteSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.contribuyente.hasPermissionToCreate
});
